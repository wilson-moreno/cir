...
public class UtilityDialog {
    ...
    public static UtilityDialog create(JFrame parent, boolean modal, EntityManager em, UtilityTree utilTree, UtilityTable utilTable, UtilityReportPrint utilPrint) {
        return new UtilityDialog(parent, modal, em, utilTree, utilTable, utilPrint);
    }
    ...
    public JDialog createDialog(String dialogName){
        ...
        switch(dialogName){
            ...
            case UtilityDialog.PROXIMITY_MAP :
                    dialog = new ProximityMapDialog(parent, true); break;
