...
drop table cis.apps_report_page if exists;
drop table cir.possible_value if exists;
drop table cir.territory if exists;


create table cir.apps_report_page(
...
alter table cir.apps_report_page add foreign key (report_id) references cir.apps_report(id);
alter table cir.apps_report_page add foreign key (page_id) references cir.apps_report(id);