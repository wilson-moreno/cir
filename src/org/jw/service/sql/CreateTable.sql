...
drop table cir.apps_report_parameters if exists;

create table cir.apps_report_parameters(
...
alter table cir.apps_report_parameters add foreign key (report_id) references cir.apps_report(id);